...
#define HDMI_AVI_BYTE(n)		HDMI_CORE_BASE(0x720 + 4 * (n))
...
#define HDMI_AUI_BYTE(n)		HDMI_CORE_BASE(0x820 + 4 * (n))
...
#define HDMI_MPG_BYTE(n)		HDMI_CORE_BASE(0x920 + 4 * (n))
...
/* SPDIF registers */
#define HDMI_SPDIF_CLK_CTRL		HDMI_SPDIF_BASE(0x000)
#define HDMI_SPDIF_OP_CTRL		HDMI_SPDIF_BASE(0x004)
#define HDMI_SPDIF_IRQ_MASK		HDMI_SPDIF_BASE(0x008)
#define HDMI_SPDIF_IRQ_STATUS		HDMI_SPDIF_BASE(0x00c)
#define HDMI_SPDIF_CONFIG_1		HDMI_SPDIF_BASE(0x010)
#define HDMI_SPDIF_CONFIG_2		HDMI_SPDIF_BASE(0x014)
#define HDMI_SPDIF_USER_VALUE_1		HDMI_SPDIF_BASE(0x020)
#define HDMI_SPDIF_USER_VALUE_2		HDMI_SPDIF_BASE(0x024)
#define HDMI_SPDIF_USER_VALUE_3		HDMI_SPDIF_BASE(0x028)
#define HDMI_SPDIF_USER_VALUE_4		HDMI_SPDIF_BASE(0x02c)
#define HDMI_SPDIF_CH_STATUS_0_1	HDMI_SPDIF_BASE(0x030)
#define HDMI_SPDIF_CH_STATUS_0_2	HDMI_SPDIF_BASE(0x034)
#define HDMI_SPDIF_CH_STATUS_0_3	HDMI_SPDIF_BASE(0x038)
#define HDMI_SPDIF_CH_STATUS_0_4	HDMI_SPDIF_BASE(0x03c)
#define HDMI_SPDIF_CH_STATUS_1		HDMI_SPDIF_BASE(0x040)
#define HDMI_SPDIF_FRAME_PERIOD_1	HDMI_SPDIF_BASE(0x048)
#define HDMI_SPDIF_FRAME_PERIOD_2	HDMI_SPDIF_BASE(0x04c)
#define HDMI_SPDIF_PC_INFO_1		HDMI_SPDIF_BASE(0x050)
#define HDMI_SPDIF_PC_INFO_2		HDMI_SPDIF_BASE(0x054)
#define HDMI_SPDIF_PD_INFO_1		HDMI_SPDIF_BASE(0x058)
#define HDMI_SPDIF_PD_INFO_2		HDMI_SPDIF_BASE(0x05c)
#define HDMI_SPDIF_DATA_BUF_0_1		HDMI_SPDIF_BASE(0x060)
#define HDMI_SPDIF_DATA_BUF_0_2		HDMI_SPDIF_BASE(0x064)
#define HDMI_SPDIF_DATA_BUF_0_3		HDMI_SPDIF_BASE(0x068)
#define HDMI_SPDIF_USER_BUF_0		HDMI_SPDIF_BASE(0x06c)
#define HDMI_SPDIF_DATA_BUF_1_1		HDMI_SPDIF_BASE(0x070)
#define HDMI_SPDIF_DATA_BUF_1_2		HDMI_SPDIF_BASE(0x074)
#define HDMI_SPDIF_DATA_BUF_1_3		HDMI_SPDIF_BASE(0x078)
#define HDMI_SPDIF_USER_BUF_1		HDMI_SPDIF_BASE(0x07c)
