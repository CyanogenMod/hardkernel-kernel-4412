#ifndef __SRP_ALP_IOCTL_H__
#define __SRP_ALP_IOCTL_H__
...
#define SRP_GET_PCM_INFO                        (0x20009)
...
#define SRP_GET_CHANNEL_COUNT			(0x30006)
#define SRP_STOP_EOS_STATE			(0x30007)
#define SRP_GET_SAMPLE_RATE		(0x30008)
#define SRP_GET_BIT_RATE			(0x30009)
