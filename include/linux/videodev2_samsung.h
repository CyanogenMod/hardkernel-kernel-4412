...
#define V4L2_CID_IS_CAMERA_SHOT_MODE_SMILE	(V4L2_CID_FIMC_IS_BASE + 102)
/* value : 1 : single shot , >=2 : continuous shot */
#define V4L2_CID_IS_CAMERA_SHOT_MODE_EYEBLINK	(V4L2_CID_FIMC_IS_BASE + 103)
/* value : 1 : single shot , >=2 : continuous shot */

#define V4L2_CID_IS_CAMERA_SENSOR_		(V4L2_CID_FIMC_IS_BASE + 201)
#define V4L2_CID_IS_CAMERA_BUF_			(V4L2_CID_FIMC_IS_BASE + 301)
...
enum is_image_effect {
	...
	IS_IMAGE_EFFECT_BLACK_WHITE,
	IS_IMAGE_EFFECT_ANTIQUE,
	IS_IMAGE_EFFECT_GREEN,
	IS_IMAGE_EFFECT_BLUE,
...
#define V4L2_CID_IS_FD_ADDRESS			(V4L2_CID_FIMC_IS_BASE + 415)
/* value : return address of FD results */
...
#define V4L2_CID_IS_CAMERA_FD_SEL_INPUT		(V4L2_CID_FIMC_IS_BASE + 481)
...
#define V4L2_CID_IS_CAMERA_INIT_WIDTH		(V4L2_CID_FIMC_IS_BASE + 464)
#define V4L2_CID_IS_CAMERA_INIT_HEIGHT		(V4L2_CID_FIMC_IS_BASE + 465)

#define V4L2_CID_IS_CMD_ISP			(V4L2_CID_FIMC_IS_BASE + 466)
...
#define V4L2_CID_IS_CMD_DRC			(V4L2_CID_FIMC_IS_BASE + 467)
...
#define V4L2_CID_IS_CMD_FD			(V4L2_CID_FIMC_IS_BASE + 468)
enum is_fd_cmd_mode {
	IS_FD_COMMAND_STOP,
	IS_FD_COMMAND_START,
	IS_FD_COMMAND_MAX
...
#define V4L2_CID_IS_CMD_ODC			(V4L2_CID_FIMC_IS_BASE + 469)
...
#define V4L2_CID_IS_CMD_DIS			(V4L2_CID_FIMC_IS_BASE + 470)
...
#define V4L2_CID_IS_CMD_TDNR			(V4L2_CID_FIMC_IS_BASE + 471)
...
#define V4L2_CID_IS_CMD_SCALERC			(V4L2_CID_FIMC_IS_BASE + 472)
...
#define V4L2_CID_IS_CMD_SCALERP			(V4L2_CID_FIMC_IS_BASE + 473)
...
#define V4L2_CID_IS_GET_SENSOR_OFFSET_X		(V4L2_CID_FIMC_IS_BASE + 474)
#define V4L2_CID_IS_GET_SENSOR_OFFSET_Y		(V4L2_CID_FIMC_IS_BASE + 475)

#define V4L2_CID_IS_GET_FRAME_VALID		(V4L2_CID_FIMC_IS_BASE + 476)
#define V4L2_CID_IS_SET_FRAME_VALID		(V4L2_CID_FIMC_IS_BASE + 477)
#define V4L2_CID_IS_GET_FRAME_BADMARK		(V4L2_CID_FIMC_IS_BASE + 478)
#define V4L2_CID_IS_SET_FRAME_NUMBER		(V4L2_CID_FIMC_IS_BASE + 479)
#define V4L2_CID_IS_GET_FRAME_NUMBER		(V4L2_CID_FIMC_IS_BASE + 480)
#endif
