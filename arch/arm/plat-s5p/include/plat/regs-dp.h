...
#define S5P_DP_AUX_ANALOG_CTL			0x37C
...
/* S5PC520 change register for debug */
#ifdef CONFIG_CPU_EXYNOS5210
#define S5P_DP_TRAINIG_DEBUG			0x904
#define S5P_DP_TRAINIG_FRAMEBUFSIZE		0x908
#define S5P_DP_TEST_PATTERN_GEN_EN		0x910
#define S5P_DP_TEST_PATTERN_GEN_CTRL		0x914
#else
#define S5P_DP_TRAINIG_DEBUG			0x950
#define S5P_DP_TRAINIG_FRAMEBUFSIZE		0x954
...
#define LINK_QUAL_PATTERN_SET			(0x3 << 2)
