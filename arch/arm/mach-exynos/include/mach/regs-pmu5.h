...
#include <mach-regs-pmu5210.h>
#include <mach-regs-pmu5250.h>
...
#define EXYNOS5_CENTRAL_SEQ_COREBLK_CONFIGURATION		S5P_PMUREG(0x0240)
#define EXYNOS5_CENTRAL_SEQ_COREBLK_STATUS			S5P_PMUREG(0x0244)
#define EXYNOS5_CENTRAL_SEQ_COREBLK_OPTION			S5P_PMUREG(0x0248)
#define EXYNOS5_SEQ_COREBLK_TRANSITION0				S5P_PMUREG(0x0260)
#define EXYNOS5_SEQ_COREBLK_TRANSITION1				S5P_PMUREG(0x0264)
#define EXYNOS5_SEQ_COREBLK_TRANSITION2				S5P_PMUREG(0x0268)
#define EXYNOS5_SEQ_COREBLK_TRANSITION3				S5P_PMUREG(0x026C)
#define EXYNOS5_SEQ_COREBLK_TRANSITION4				S5P_PMUREG(0x0270)
#define EXYNOS5_SEQ_COREBLK_TRANSITION5				S5P_PMUREG(0x0274)
#define EXYNOS5_SEQ_COREBLK_TRANSITION6				S5P_PMUREG(0x0278)
#define EXYNOS5_SEQ_COREBLK_TRANSITION7				S5P_PMUREG(0x027C)
...
#define EXYNOS5_WAKEUP_STAT_COREBLK				S5P_PMUREG(0x0620)
#define EXYNOS5_EINT_WAKEUP_MASK_COREBLK			S5P_PMUREG(0x0624)
#define EXYNOS5_WAKEUP_MASK_COREBLK				S5P_PMUREG(0x0628)
#define EXYNOS5_WAKEUP_INTERRUPT_COREBLK			S5P_PMUREG(0x062C)
...
#define EXYNOS5_CMU_ACLKSTOP_COREBLK_SYS_PWR_REG		S5P_PMUREG(0x1120)
#define EXYNOS5_CMU_SCLKSTOP_COREBLK_SYS_PWR_REG		S5P_PMUREG(0x1124)
#define EXYNOS5_CMU_RESET_COREBLK_SYS_PWR_REG			S5P_PMUREG(0x112C)
...
#define EXYNOS5_TOP_BUS_COREBLK_SYS_PWR_REG			S5P_PMUREG(0x1190)
#define EXYNOS5_TOP_RETENTION_COREBLK_SYS_PWR_REG		S5P_PMUREG(0x1194)
#define EXYNOS5_TOP_PWR_COREBLK_SYS_PWR_REG			S5P_PMUREG(0x1198)
#define EXYNOS5_LOGIC_RESET_SYS_PWR_REG				S5P_PMUREG(0x11A0)
#define EXYNOS5_OSCCLK_GATE_SYS_PWR_REG				S5P_PMUREG(0x11A4)
#define EXYNOS5_LOGIC_RESET_COREBLK_SYS_PWR_REG			S5P_PMUREG(0x11B0)
#define EXYNOS5_OSCCLK_GATE_COREBLK_SYS_PWR_REG			S5P_PMUREG(0x11B4)
...
#define EXYNOS5_PAD_RETENTION_GPIO_COREBLK_SYS_PWR_REG		S5P_PMUREG(0x123C)
#define EXYNOS5_PAD_ISOLATION_SYS_PWR_REG			S5P_PMUREG(0x1240)
#define EXYNOS5_PAD_ISOLATION_COREBLK_SYS_PWR_REG		S5P_PMUREG(0x1250)
...
#define EXYNOS5_GPIO_MODE_COREBLK_SYS_PWR_REG			S5P_PMUREG(0x1320)
...
#define EXYNOS5_CMU_ACLKSTOP_COREBLK_CONFIGURATION		S5P_PMUREG(0x2900)
#define EXYNOS5_CMU_ACLKSTOP_COREBLK_STATUS			S5P_PMUREG(0x2904)
#define EXYNOS5_CMU_ACLKSTOP_COREBLK_OPTION			S5P_PMUREG(0x2908)
#define EXYNOS5_CMU_SCLKSTOP_COREBLK_CONFIGURATION		S5P_PMUREG(0x2920)
#define EXYNOS5_CMU_SCLKSTOP_COREBLK_STATUS			S5P_PMUREG(0x2924)
#define EXYNOS5_CMU_SCLKSTOP_COREBLK_OPTION			S5P_PMUREG(0x2928)
#define EXYNOS5_CMU_RESET_COREBLK_CONFIGURATION			S5P_PMUREG(0x2960)
#define EXYNOS5_CMU_RESET_COREBLK_STATUS			S5P_PMUREG(0x2964)
#define EXYNOS5_CMU_RESET_COREBLK_OPTION			S5P_PMUREG(0x2968)
...
#define EXYNOS5_TOP_BUS_COREBLK_CONFIGURATION			S5P_PMUREG(0x2C80)
#define EXYNOS5_TOP_BUS_COREBLK_STATUS				S5P_PMUREG(0x2C84)
#define EXYNOS5_TOP_BUS_COREBLK_OPTION				S5P_PMUREG(0x2C88)
#define EXYNOS5_TOP_RETENTION_COREBLK_CONFIGURATION		S5P_PMUREG(0x2CA0)
#define EXYNOS5_TOP_RETENTION_COREBLK_STATUS			S5P_PMUREG(0x2CA4)
#define EXYNOS5_TOP_RETENTION_COREBLK_OPTION			S5P_PMUREG(0x2CA8)
#define EXYNOS5_TOP_PWR_COREBLK_CONFIGURATION			S5P_PMUREG(0x2CC0)
#define EXYNOS5_TOP_PWR_COREBLK_STATUS				S5P_PMUREG(0x2CC4)
#define EXYNOS5_TOP_PWR_COREBLK_OPTION				S5P_PMUREG(0x2CC8)
...
#define EXYNOS5_LOGIC_RESET_COREBLK_CONFIGURATION		S5P_PMUREG(0x2D80)
#define EXYNOS5_LOGIC_RESET_COREBLK_STATUS			S5P_PMUREG(0x2D84)
#define EXYNOS5_LOGIC_RESET_COREBLK_OPTION			S5P_PMUREG(0x2D88)
#define EXYNOS5_OSCCLK_GATE_COREBLK_CONFIGURATION		S5P_PMUREG(0x2DA0)
#define EXYNOS5_OSCCLK_GATE_COREBLK_STATUS			S5P_PMUREG(0x2DA4)
#define EXYNOS5_OSCCLK_GATE_COREBLK_OPTION			S5P_PMUREG(0x2DA8)
...
#define EXYNOS5_PAD_RETENTION_GPIO_COREBLK_CONFIGURATION	S5P_PMUREG(0x31E0)
#define EXYNOS5_PAD_RETENTION_GPIO_COREBLK_STATUS		S5P_PMUREG(0x31E4)
#define EXYNOS5_PAD_RETENTION_GPIO_COREBLK_OPTION		S5P_PMUREG(0x31E8)
...
#define EXYNOS5_PAD_ISOLATION_COREBLK_CONFIGURATION		S5P_PMUREG(0x3280)
#define EXYNOS5_PAD_ISOLATION_COREBLK_STATUS			S5P_PMUREG(0x3284)
#define EXYNOS5_PAD_ISOLATION_COREBLK_OPTION			S5P_PMUREG(0x3288)
...
#define EXYNOS5_GPIO_MODE_COREBLK_CONFIGURATION			S5P_PMUREG(0x3900)
#define EXYNOS5_GPIO_MODE_COREBLK_STATUS			S5P_PMUREG(0x3904)
#define EXYNOS5_GPIO_MODE_COREBLK_OPTION			S5P_PMUREG(0x3908)
