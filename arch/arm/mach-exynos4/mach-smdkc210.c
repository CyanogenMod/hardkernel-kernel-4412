...
#endif
#endif /* (CONFIG_VIDEO_FIMC) || defined(CONFIG_VIDEO_SAMSUNG_S5P_FIMC) */
...
static struct s5k4ba_mbus_platform_data s5k4ba_mbus_plat = {
	...
	.clk_rate	= 24000000UL,
#ifdef CONFIG_ITU_A
	.set_power	= smdkc210_cam0_reset,
#endif
#ifdef CONFIG_ITU_B
	.set_power	= smdkc210_cam1_reset,
#endif
};
...
/* CONFIG_VIDEO_FIMC & CONFIG_VIDEO_FIMC_MIPI are the feature for legacy */
#ifdef CONFIG_VIDEO_FIMC
	&s3c_device_fimc0,
	&s3c_device_fimc1,
	&s3c_device_fimc2,
...
static void __init smdkc210_subdev_config(void)
{
	s3c_fimc0_default_data.isp_info[0] = &isp_info[0];
}

static void __init smdkc210_camera_config(void)
{
	int i = 0;
...
#ifdef CONFIG_VIDEO_SAMSUNG_S5P_FIMC
	smdkc210_camera_config();
	smdkc210_subdev_config();
