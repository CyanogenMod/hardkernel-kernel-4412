...
static int exynos_ss_udc_poll_bit_set(void __iomem *ptr, u32 val, int timeout)
{
	u32 reg;
...
static int exynos_ss_udc_poll_bit_clear(void __iomem *ptr, u32 val, int timeout)
{
	u32 reg;
