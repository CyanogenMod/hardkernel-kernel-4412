...
#define S5P_HDNI_PHY_STATUS0			S5P_HDMI_CTRL_BASE(0x020)
#define S5P_HDNI_PHY_STATUS_PLL			S5P_HDMI_CTRL_BASE(0x028)
#define S5P_HDNI_PHY_CON_0			S5P_HDMI_CTRL_BASE(0x030)

#define S5P_HDNI_HPD_CTRL			S5P_HDMI_CTRL_BASE(0x040)
#define S5P_HDNI_HPD_th_0			S5P_HDMI_CTRL_BASE(0x050)
#define S5P_HDNI_HPD_th_1			S5P_HDMI_CTRL_BASE(0x054)
#define S5P_HDNI_HPD_th_2			S5P_HDMI_CTRL_BASE(0x058)
#define S5P_HDNI_HPD_th_3			S5P_HDMI_CTRL_BASE(0x05C)
...
/* HDMISPDIFregister */
#define S5P_HDMI_SPDIF_CLK_CTRL			S5P_HDMI_SPDIF_BASE(0x000)
#define S5P_HDMI_SPDIF_OP_CTRL			S5P_HDMI_SPDIF_BASE(0x004)
#define S5P_HDMI_SPDIF_IRQ_MASK			S5P_HDMI_SPDIF_BASE(0x008)
#define S5P_HDMI_SPDIF_IRQ_STATUS		S5P_HDMI_SPDIF_BASE(0x00c)
#define S5P_HDMI_SPDIF_CONFIG_1			S5P_HDMI_SPDIF_BASE(0x010)
#define S5P_HDMI_SPDIF_CONFIG_2			S5P_HDMI_SPDIF_BASE(0x014)
#define S5P_HDMI_SPDIF_USER_VALUE_1		S5P_HDMI_SPDIF_BASE(0x020)
#define S5P_HDMI_SPDIF_USER_VALUE_2		S5P_HDMI_SPDIF_BASE(0x024)
#define S5P_HDMI_SPDIF_USER_VALUE_3		S5P_HDMI_SPDIF_BASE(0x028)
#define S5P_HDMI_SPDIF_USER_VALUE_4		S5P_HDMI_SPDIF_BASE(0x02c)
#define S5P_HDMI_SPDIF_CH_STATUS_0_1		S5P_HDMI_SPDIF_BASE(0x030)
#define S5P_HDMI_SPDIF_CH_STATUS_0_2		S5P_HDMI_SPDIF_BASE(0x034)
#define S5P_HDMI_SPDIF_CH_STATUS_0_3		S5P_HDMI_SPDIF_BASE(0x038)
#define S5P_HDMI_SPDIF_CH_STATUS_0_4		S5P_HDMI_SPDIF_BASE(0x03c)
#define S5P_HDMI_SPDIF_CH_STATUS_1		S5P_HDMI_SPDIF_BASE(0x040)
#define S5P_HDMI_SPDIF_FRAME_PERIOD_1		S5P_HDMI_SPDIF_BASE(0x048)
#define S5P_HDMI_SPDIF_FRAME_PERIOD_2		S5P_HDMI_SPDIF_BASE(0x04c)
#define S5P_HDMI_SPDIF_PC_INFO_1		S5P_HDMI_SPDIF_BASE(0x050)
#define S5P_HDMI_SPDIF_PC_INFO_2		S5P_HDMI_SPDIF_BASE(0x054)
#define S5P_HDMI_SPDIF_PD_INFO_1		S5P_HDMI_SPDIF_BASE(0x058)
#define S5P_HDMI_SPDIF_PD_INFO_2		S5P_HDMI_SPDIF_BASE(0x05c)
#define S5P_HDMI_SPDIF_DATA_BUF_0_1		S5P_HDMI_SPDIF_BASE(0x060)
#define S5P_HDMI_SPDIF_DATA_BUF_0_2		S5P_HDMI_SPDIF_BASE(0x064)
#define S5P_HDMI_SPDIF_DATA_BUF_0_3		S5P_HDMI_SPDIF_BASE(0x068)
#define S5P_HDMI_SPDIF_USER_BUF_0		S5P_HDMI_SPDIF_BASE(0x06c)
#define S5P_HDMI_SPDIF_DATA_BUF_1_1		S5P_HDMI_SPDIF_BASE(0x070)
#define S5P_HDMI_SPDIF_DATA_BUF_1_2		S5P_HDMI_SPDIF_BASE(0x074)
#define S5P_HDMI_SPDIF_DATA_BUF_1_3		S5P_HDMI_SPDIF_BASE(0x078)
#define S5P_HDMI_SPDIF_USER_BUF_1		S5P_HDMI_SPDIF_BASE(0x07c)
