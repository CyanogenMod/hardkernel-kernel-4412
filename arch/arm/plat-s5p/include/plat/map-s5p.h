...
#define S5P_VA_PPMU_DDR_C	S3C_ADDR(0x02960000)
#define S5P_VA_PPMU_DDR_R1	S3C_ADDR(0x02970000)
#define S5P_VA_PPMU_DDR_L	S3C_ADDR(0x02980000)
#define S5P_VA_PPMU_RIGHT0_BUS	S3C_ADDR(0x02990000)
