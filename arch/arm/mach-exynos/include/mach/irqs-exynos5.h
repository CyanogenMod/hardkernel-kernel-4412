...
#define IRQ_SYSMMU_MCUISP_0	COMBINER_IRQ(5, 2)
#define IRQ_SYSMMU_MCUISP_1	COMBINER_IRQ(5, 3)
#define IRQ_SYSMMU_SCALERCISP_0	COMBINER_IRQ(5, 4)
#define IRQ_SYSMMU_SCALERCISP_1	COMBINER_IRQ(5, 5)
