...
#define IS_ERROR_VER 006 /* IS ERROR VERSION 0.06 */
...
#define IS_ERROR_SENSOR_PWRDN_FAIL	(IS_ERROR_INVALID_PATH+1)
#define IS_ERROR_ISP_PWRDN_FAIL		(IS_ERROR_SENSOR_PWRDN_FAIL+1)
#define IS_ERROR_DRC_PWRDN_FAIL		(IS_ERROR_ISP_PWRDN_FAIL+1)
#define IS_ERROR_FD_PWRDN_FAIL		(IS_ERROR_DRC_PWRDN_FAIL+1)
#define IS_ERROR_TIME_OUT		(IS_ERROR_FD_PWRDN_FAIL+1)
#define IS_ERROR_OPEN_SENSOR_FAIL	(IS_ERROR_TIME_OUT+1)
#define IS_ERROR_ISP_FRAME_END_TIME_OUT	(IS_ERROR_OPEN_SENSOR_FAIL+1)
#define IS_ERROR_DRC_FRAME_END_TIME_OUT	(IS_ERROR_ISP_FRAME_END_TIME_OUT+1)
#define IS_ERROR_LHFD_FRAME_END_TIME_OUT (IS_ERROR_DRC_FRAME_END_TIME_OUT+1)
#define IS_ERROR_ENTRY_MSG_THREAD_DOWN	(IS_ERROR_LHFD_FRAME_END_TIME_OUT+1)
