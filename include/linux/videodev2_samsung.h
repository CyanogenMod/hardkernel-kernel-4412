...
#define V4L2_CID_IS_FD_NUM_FACE			(V4L2_CID_FIMC_IS_BASE + 414)
/* value : maximum number of face */

#define V4L2_CID_IS_FD_GET_FACE_COUNT		(V4L2_CID_FIMC_IS_BASE + 416)
#define V4L2_CID_IS_FD_GET_FACE_FRAME_NUMBER	(V4L2_CID_FIMC_IS_BASE + 417)
#define V4L2_CID_IS_FD_GET_FACE_CONFIDENCE	(V4L2_CID_FIMC_IS_BASE + 418)
#define V4L2_CID_IS_FD_GET_FACE_SMILELEVEL	(V4L2_CID_FIMC_IS_BASE + 419)
#define V4L2_CID_IS_FD_GET_FACE_BLINKLEVEL	(V4L2_CID_FIMC_IS_BASE + 420)
#define V4L2_CID_IS_FD_GET_FACE_OFFSET_X	(V4L2_CID_FIMC_IS_BASE + 421)
#define V4L2_CID_IS_FD_GET_FACE_OFFSET_Y	(V4L2_CID_FIMC_IS_BASE + 422)
#define V4L2_CID_IS_FD_GET_FACE_SIZE_X		(V4L2_CID_FIMC_IS_BASE + 423)
#define V4L2_CID_IS_FD_GET_FACE_SIZE_Y		(V4L2_CID_FIMC_IS_BASE + 424)
#define V4L2_CID_IS_FD_GET_LEFT_EYE_OFFSET_X	(V4L2_CID_FIMC_IS_BASE + 425)
#define V4L2_CID_IS_FD_GET_LEFT_EYE_OFFSET_Y	(V4L2_CID_FIMC_IS_BASE + 426)
#define V4L2_CID_IS_FD_GET_LEFT_EYE_SIZE_X	(V4L2_CID_FIMC_IS_BASE + 427)
#define V4L2_CID_IS_FD_GET_LEFT_EYE_SIZE_Y	(V4L2_CID_FIMC_IS_BASE + 428)
#define V4L2_CID_IS_FD_GET_RIGHT_EYE_OFFSET_X	(V4L2_CID_FIMC_IS_BASE + 429)
#define V4L2_CID_IS_FD_GET_RIGHT_EYE_OFFSET_Y	(V4L2_CID_FIMC_IS_BASE + 430)
#define V4L2_CID_IS_FD_GET_RIGHT_EYE_SIZE_X	(V4L2_CID_FIMC_IS_BASE + 431)
#define V4L2_CID_IS_FD_GET_RIGHT_EYE_SIZE_Y	(V4L2_CID_FIMC_IS_BASE + 432)
#define V4L2_CID_IS_FD_GET_MOUTH_OFFSET_X	(V4L2_CID_FIMC_IS_BASE + 433)
#define V4L2_CID_IS_FD_GET_MOUTH_OFFSET_Y	(V4L2_CID_FIMC_IS_BASE + 434)
#define V4L2_CID_IS_FD_GET_MOUTH_SIZE_X		(V4L2_CID_FIMC_IS_BASE + 435)
#define V4L2_CID_IS_FD_GET_MOUTH_SIZE_Y		(V4L2_CID_FIMC_IS_BASE + 436)
#define V4L2_CID_IS_FD_GET_ANGLE		(V4L2_CID_FIMC_IS_BASE + 437)
#define V4L2_CID_IS_FD_SET_ORIENTATION		(V4L2_CID_FIMC_IS_BASE + 438)
#define V4L2_CID_IS_FD_SET_DATA_ADDRESS		(V4L2_CID_FIMC_IS_BASE + 439)
#define V4L2_CID_IS_FD_GET_DATA			(V4L2_CID_FIMC_IS_BASE + 500)
#define V4L2_CID_IS_FD_SET_YAW_ANGLE		(V4L2_CID_FIMC_IS_BASE + 501)
#define V4L2_CID_IS_FD_SET_ROLL_ANGLE		(V4L2_CID_FIMC_IS_BASE + 502)
