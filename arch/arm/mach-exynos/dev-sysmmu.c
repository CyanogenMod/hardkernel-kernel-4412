...
SYSMMU_RESOURCE(fimc_isp, FIMC_ISP, FIMC_ISP);
SYSMMU_RESOURCE(fimc_drc, FIMC_DRC, FIMC_DRC);
SYSMMU_RESOURCE(fimc_fd, FIMC_FD, FIMC_DRC);
SYSMMU_RESOURCE(ispcpu,	ISPCPU, FIMC_CX);
...
SYSMMU_PLATFORM_DEVICE(fimc_isp, 16);
SYSMMU_PLATFORM_DEVICE(fimc_drc, 17);
SYSMMU_PLATFORM_DEVICE(fimc_fd,	18);
SYSMMU_PLATFORM_DEVICE(ispcpu,	19);
